  ...
  return (
    <div>
      ...
      <Carousel.Item interval={3000}>
        <img src={photo} alt="first" style={{width:"100%",height:"55vh"}}/>
        <Carousel.Caption>
        <img src={logo} alt="img"className='logo_animation'/>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item interval={3000}>
      <img src={photo} alt="second" style={{width:"100%",height:"55vh"}}/>
        <Carousel.Caption>
        <img src={logo} alt="img"className='logo_animation'/>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item interval={3000}>
      <img src={photo} alt="third" style={{width:"100%",height:"55vh"}}/>
        <Carousel.Caption>
